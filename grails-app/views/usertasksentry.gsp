  		...
  		<tbody>
			<g:each in="${usertasksentry}" status="i" var="UserTasksEntry">
	  			...
	  			<tr>
	  				...
	  				<td>
	  				<g:link id="${fieldValue(bean:UserTasksEntry, field:'id')}" class="confirm-delete" controller="UserTaskEntry" action="editUserTask"><i class="icon-pencil" title="Edit"></i></g:link> | <g:link id="${fieldValue(bean:UserTasksEntry, field:'id')}" class="confirm-delete" controller="UserTaskEntry" action="delete" data-confirm="Are you sure you want to delete?"><i class="icon-remove" title="Delete"></i></g:link></td>
	  			</tr>
	  		</g:each>
  		</tbody>
  	</table>
...
<div class="controls">
<select name="task" class="input-xlarge" ><option value="task1">Task1</option><option value="task2">Task2</option><option value="task3">Task3</option></select>
</div>
</div>
